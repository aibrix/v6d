...
Status KVCacheManager::Update(
  ...
  LOG_UPDATE("update_v", startTime, endTime, status, 0 /* prefix length */,
...
Status KVCacheManager::Update(
  ...
  double endTime = LOG_GET_CURRENT_TIME();
  LOG_UPDATE("update_v_v", startTime, endTime, status, prefix.size(),
             tokenList.size(), updated);
  return status;
}
...
Status KVCacheManager::Update(
  ...
  double endTime = LOG_GET_CURRENT_TIME();
  LOG_UPDATE("update_v_i", startTime, endTime, status, tokenList.size(),
...
Status KVCacheManager::Query(
  ...
  double endTime = LOG_GET_CURRENT_TIME();
  LOG_QUERY("query_v", startTime, endTime, status, 0 /* prefix length */,
...
Status KVCacheManager::Query(const std::vector<int>& prefix, int nextToken,
  ...
  double endTime = LOG_GET_CURRENT_TIME();
  LOG_QUERY("query_v_i", startTime, endTime, status, prefix.size(),
...
Status KVCacheManager::Query(
  ...
  double endTime = LOG_GET_CURRENT_TIME();
  LOG_QUERY("query_v_v", startTime, endTime, status, prefix.size(),
            tokenList.size(), matched);
  return status;
}
